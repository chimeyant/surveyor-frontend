<template>
  <div>
    ...
    >
      ...
      <div
        v-if="device.desktop"
        style=" width:120%; margin-left: 0%; background-color: blue;  height: 1000px;border-radius: 50%;top: 10px; margin-top: -700px  ; position: absolute; overflow: hidden; border-style: solid; border-width: 10px; border-color: grey;"
      >
        <img
          src="images/ta.jpeg"
          alt=""
      ...
      <div style="text-align: center; justify-content: center; margin-top: 10%; ">
        ...
        >
          <v-card-text>
            <v-col cols="12">
              <div class="title font-weight-bold">SIMP HATI</div>
              <div class="body-2">Sistem Informasi Manajemen Pelaporan Harian Tenaga Ahli</div>
            </v-col>
            <div class="mt-10"></div>
            <v-col>
              <v-text-field
            ...
            <v-col class="mt-16">
              <div class="body-2">Copyright &COPY; 2023 Dinas Komunikasi Informatika Persandian dan Statistik</div>
            </v-col>
          </v-card-text>
        </v-card>
